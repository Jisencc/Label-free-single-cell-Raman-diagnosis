...
OUT_DIR = "./publication_stage1_binary_fpch_ablation_reproduction_out_CV3"

CONTROL_LABEL = "Control"

LOCKED_INPUT_DIR = "./publication_stage1_binary_ablation_inputs_CV3"
...
# FP+CH ablation only: no "all" view.
