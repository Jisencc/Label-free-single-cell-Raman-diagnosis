...
OUT_DIR = "./publication_MIL_disease3_reproduction_out_CV3"

LOCKED_INPUT_DIR = "./publication_stage1_disease3_MIL_inputs_CV3"
LOCKED_RUNS_CSV = os.path.join(LOCKED_INPUT_DIR, "selected_rep_MIL_DISEASE3_RAMANONLY_LOCKED_RUNS.csv")
EXPECTED_SELECTED_REP = 10  # fill with the selected rep used to create the locked input folder
